...
--
-- Host: localhost
-- Generation Time: Oct 21, 2017 at 02:54 PM
...
(18, 'ก็อร่อยดีนะ', 11),
(19, 'ร้านนี้เก่าแก่มาก โดยเฉพาะคนขาย แต่อร่อยกว่า ข้าวต้มก็ สาวร้านเกี๋ยวซ่าละ', 98),
(20, 'ร้านดูสะอาด', 20),
(21, 'อร่อยๆๆๆ', 6),
(22, 'อย่าพลาด', 49),
(23, 'น้ำข้นเข็มข้นมากค้า เส้นเหนียวนุ่มอร่อยฟินสุดๆไปเลย', 77);
...
(36, '1508122369780.jpg', 20),
(37, '1508122418643.jpg', 20),
(38, '1508299538575.jpg', 6),
(39, '1508300011965.jpg', 1),
(40, '1508300069809.jpg', 1),
(41, '1508567073427.jpg', 77),
(42, '1508567217927.jpg', 77);
...
(1, 'sittikiat', '123456', 'miikeoho@hotmail.com', '1506677425124.jpg');
...
--
ALTER TABLE `comment`
  MODIFY `id_comment` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัสคอมเม้น', AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `restaurant_image`
  MODIFY `id_restaurant_image` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรูปภาพร้านอาหาร', AUTO_INCREMENT=43;
--
